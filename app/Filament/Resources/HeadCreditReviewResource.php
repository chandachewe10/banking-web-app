...
class HeadCreditReviewResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Head Credit Evaluation';
    protected static ?string $recordTitleAttribute = 'Head Credit Evaluation';
    ...
    {
        return [
            'index' => Pages\ListHeadCreditReviews::route('/'),
            'create' => Pages\CreateHeadCreditReview::route('/create'),
            'edit' => Pages\EditHeadCreditReview::route('/{record}/edit'),
        ];
    }
}
